...
# Load model bundle
MODEL_PATH = os.path.join(os.path.dirname(__file__), "xgb_stroke_optuna_model.pkl")
...
# --- PENTING: Panggil load_model() di sini agar berjalan saat di-start oleh Gunicorn ---
load_model()
